...
function table(products: ComparisonProduct[], rows: ComparisonRow[]): ComparisonTableData {
...
export const comparisonTables: Record<string, ComparisonTableData> = {
    'dbeaver-alternative': table(
        ...
        [
            ...
            {
                feature: 'Platforms',
                values: [TABULARIS_CORE_ROWS.platforms + ' (Tauri)', 'macOS · Linux · Windows (Eclipse RCP)'],
            },
    ...
    'beekeeper-studio-alternative': table(
        ...
        [
            ...
            {
                feature: 'Databases',
                values: [TABULARIS_CORE_ROWS.databases, 'PG, MySQL, SQLite, SQL Server, MariaDB, others'],
            },
            {
                feature: 'Platforms',
                values: [TABULARIS_CORE_ROWS.platforms + ' (Tauri)', 'macOS · Linux · Windows (Electron)'],
            },
        ],
    ),
    ...
    'dbgate-alternative': table(
        ...
        [
            ...
            {
                feature: 'Platforms',
                values: [TABULARIS_CORE_ROWS.platforms + ' (Tauri)', 'macOS · Linux · Windows · web (Electron)'],
            },
        ],
    ),
    ...
    'heidisql-alternative': table(
        ...
        [
            ...
            {
                feature: 'Databases',
                values: [TABULARIS_CORE_ROWS.databases, 'MySQL, MariaDB, PostgreSQL, SQL Server, SQLite'],
            },
            {
                feature: 'Platforms',
                values: [TABULARIS_CORE_ROWS.platforms + ' (native)', 'Windows native · Wine elsewhere'],
            },
    ...
    'tableplus-vs-datagrip-vs-tabularis': table(
        ...
        [
            ...
            {
                feature: 'Pricing',
                values: [TABULARIS_CORE_ROWS.pricing, 'Freemium · Paid license', 'Paid (subscription)'],
            },
            {feature: 'SQL notebooks', values: [TABULARIS_CORE_ROWS.notebooks, '❌', '❌']},
            {feature: 'Plugin system', values: [TABULARIS_CORE_ROWS.plugins, '❌', '✅ JetBrains marketplace']},
            {feature: 'MCP / AI integration', values: [TABULARIS_CORE_ROWS.mcp, '❌', '❌']},
            ...
            {feature: 'Databases', values: [TABULARIS_CORE_ROWS.databases, '~20 backends', 'Many via JDBC']},
            {
                feature: 'Platforms',
                values: [
                    TABULARIS_CORE_ROWS.platforms + ' (Tauri)',
                    'macOS · Linux · Windows · iOS',
                    'macOS · Linux · Windows (JVM)',
                ],
            },
        ],
    ),
