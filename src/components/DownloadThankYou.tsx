...
export function DownloadThankYou() {
  ...
  return (
    <>
      ...
      <div className="dl-star-banner">
        <span className="dl-star-banner__mark" aria-hidden="true">
          <svg
            width="28"
            height="28"
            viewBox="0 0 24 24"
        ...
        <div className="dl-star-banner__body">
          <strong>While Tabularis downloads…</strong>
          <span>
            A star takes 2 seconds and is the single biggest way to help an
            open-source project grow.
          </span>
        </div>
        <GithubStarsButton
          stars={stars}
          label="Star on GitHub"
          onClick={() => trackEvent("invite-github-star", "click", "thank-you")}
        />
      </div>
      ...
      <div className="dl-thankyou-cards">
        ...
        >
          ...
          <h3 className="dl-thankyou-card-title">Contribute on GitHub</h3>
          <p className="dl-thankyou-card-desc">
