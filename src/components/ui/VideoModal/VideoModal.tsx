...
const FOCUSABLE_SELECTOR = 'video, button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])';
        ...
        >
            ...
            >
                <VideoPlayer
                    src={src}
                    poster={poster}
                    wrapperClassName={styles.player}
                    videoClassName={styles.playerVideo}
