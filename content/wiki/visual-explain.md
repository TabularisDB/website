...
The analysis is generated in the language configured in Tabularis (any of the nine supported UI languages, from Italian to Japanese to Tagalog), so you do not need to reason about plans in English if that is not your working language.
