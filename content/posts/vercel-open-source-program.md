...
og:
  ...
  accent: "Vercel Open Source Program."
  claim: "Accepted into the Spring 2026 cohort — twelve months of support for the open-source site behind the project."
  image: "/img/overview.png"
---

# Tabularis Joins the Vercel Open Source Program

<p style="text-align:center;margin:1.5rem 0 2rem;"><img class="no-lightbox" src="/img/posts/vercel-partnership.svg" alt="Tabularis has joined the Vercel Open Source Program — Spring 2026 cohort" style="width:100%;max-width:800px;height:auto;display:block;margin:0 auto;" /></p>

A short while after [DigitalOcean welcomed us into their Open Source Credits Program](/blog/digitalocean-opensource-sponsorship), we got another email we weren't expecting: **Tabularis has been accepted into the [Vercel Open Source Program](https://vercel.com/open-source-program), in the Spring 2026 cohort.**
...
**This site is the thing being supported.** [tabularis.dev](https://tabularis.dev) — the page you're reading this on, the wiki, the changelog, the plugin pages — is a Next.js app, it's [open source](https://github.com/TabularisDB/website), and it's the front door to everything else we build. The download links, the docs people land on from a Google search, the release notes that go out every couple of weeks: all of it runs through here.
...
If you've got an idea for what the site should do better, the [repo is right there](https://github.com/TabularisDB/website). Issues and PRs are open.

:::star:::

## Thanks, and the usual honest note

To [Amy](https://x.com/AmyAEgan) and the team running the Vercel Open Source Program: thank you. Picking a young project out of a stack of strong applications is a vote of confidence, and we don't take it as a given.
