...
**And 1Password asks for nothing in return.** No required blog post, no logo on our homepage, no "sponsored by" badge, no obligation of any kind. This post is not a deliverable; nobody asked for it. We're writing it for one reason: the product is genuinely good, the program is a genuinely generous thing to offer maintainers who are footing the bill themselves, and more of them should know it exists. Credit where it's due, freely given.
